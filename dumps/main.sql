...
ALTER ROLE postgres WITH SUPERUSER INHERIT CREATEROLE CREATEDB LOGIN REPLICATION BYPASSRLS UNENCRYPTED PASSWORD 'quod erat demonstrandum';
CREATE ROLE qedb;
ALTER ROLE qedb WITH NOSUPERUSER INHERIT NOCREATEROLE NOCREATEDB LOGIN NOREPLICATION NOBYPASSRLS CONNECTION LIMIT 100 UNENCRYPTED PASSWORD 'quod erat demonstrandum';
