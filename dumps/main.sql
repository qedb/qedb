...
CREATE TABLE condition_proof (
    ...
    CONSTRAINT rule_or_proof_or_evident_or_adopt CHECK (((((((follows_rule_id IS NOT NULL))::integer + ((follows_proof_id IS NOT NULL))::integer) + (adopt_condition)::integer) + (self_evident)::integer) = 1))
);
...
CREATE TABLE step (
    ...
    CONSTRAINT valid_parameters CHECK ((((previous_id = NULL::integer) AND (step_type = 'set'::step_type)) OR ((previous_id <> NULL::integer) AND (((step_type = 'copy_proof'::step_type) AND (proof_id IS NOT NULL)) OR ((step_type = 'copy_rule'::step_type) AND (rule_id IS NOT NULL)) OR ((step_type = 'rearrange'::step_type) AND (rearrange_format IS NOT NULL)) OR ((step_type = 'substitute_rule'::step_type) AND (rule_id IS NOT NULL)) OR ((step_type = 'substitute_proof'::step_type) AND (proof_id IS NOT NULL)) OR ((step_type = 'substitute_free'::step_type) AND (substitution_id IS NOT NULL))))))
);
...
49	\\x000000000500030012000000090000000a0000001700000004000000000000000000020002000300040102	\\xc7d8f22539d6739dda9344468456d2aa4f3811a6b84f4b0ebe97213240a313b1	\\frac{\\partial}{\\partial{}_\\text{?}x}{}_\\text{?}a{}_\\text{?}b	{18,9,10,23,4}	function	23	{19,6}
50	\\x0000000003000200120000000900000017000000000000000200020001	\\x80b7e6a6114ad59b7efc59e23496d37eaa3eaa0950e96cefd8bb945d388558bd	\\frac{\\partial}{\\partial{}_\\text{?}x}{}_\\text{?}a	{18,9,23}	function	23	{19,1}
51	\\x000000000500030012000000090000000a0000000400000017000000000000000000020002000304000102	\\x843791e3157ea584c77bad57a6a2b1616510951569f3fe72dd7963dc0bc38c77	\\left(\\frac{\\partial}{\\partial{}_\\text{?}x}{}_\\text{?}a\\right){}_\\text{?}b	{18,9,10,4,23}	function	4	{50,2}
52	\\x0000000003000200120000000a00000017000000000000000200020001	\\x94fd9cb9ec94efba26d3493b5a7198d9be6209647f150d423efcec5a197e00df	\\frac{\\partial}{\\partial{}_\\text{?}x}{}_\\text{?}b	{18,10,23}	function	23	{19,2}
53	\\x000000000500030009000000120000000a0000000400000017000000000000000000020002000300040102	\\x0947b85212ed01ccaeec252d28c82974be42da4d21df7f107a87827298e7f5a8	{}_\\text{?}a\\frac{\\partial}{\\partial{}_\\text{?}x}{}_\\text{?}b	{9,18,10,4,23}	function	4	{1,52}
54	\\x000000000600030012000000090000000a0000000200000004000000170000000000000000000200020002000304050001020401050002	\\x1ae2e8443c06be2ee59c9e70bcfd10792acbcaa27e280d6fdb674bbafc565647	\\left(\\frac{\\partial}{\\partial{}_\\text{?}x}{}_\\text{?}a\\right){}_\\text{?}b+{}_\\text{?}a\\frac{\\partial}{\\partial{}_\\text{?}x}{}_\\text{?}b	{18,9,10,2,4,23}	function	2	{51,53}
55	\\x000001000200010000000000090000000200000000000200010200	\\xc1643dedd639c96950f9dc40955b094ee6f7c686847444dbdb5b168e60218586	0+{}_\\text{?}a	{9,2}	function	2	{23,1}
56	\\x000001000200010000000000090000000400000000000200010200	\\x77ca76e6b8c82d47b148ca0b4ada2224dce12fec41fa2a4e2b1b2da36a4fd5a1	0{}_\\text{?}a	{9,4}	function	4	{23,1}
57	\\x0000010002000100000000000a0000000400000000000200010200	\\xd5c8739b3d8ec684ddf6b813a613f0b2a6cef4d3ecf65799a2289549801fe550	0{}_\\text{?}b	{10,4}	function	4	{23,2}
58	\\x0000010006000300000000000a0000000900000012000000020000000400000017000000000000000000020002000200030406000401050200	\\x00336dde635e380c504c1e5d020eab9643b46d9ece34717cd4f0ec50955e4ad5	0{}_\\text{?}b+{}_\\text{?}a\\frac{\\partial}{\\partial{}_\\text{?}x}{}_\\text{?}b	{10,9,18,2,4,23}	function	2	{57,53}
59	\\x00000100060003000000000009000000120000000a00000002000000040000001700000000000000000002000200020003060400050102	\\x64079b16c40efb5ba1963fa885e72fa24ce5390edb0bee1dd8a0f3304c8a783b	0+{}_\\text{?}a\\frac{\\partial}{\\partial{}_\\text{?}x}{}_\\text{?}b	{9,18,10,2,4,23}	function	2	{23,53}
\.
...
SELECT pg_catalog.setval('expression_id_seq', 59, true);
...
28	3	25	f	f	2	vec2	abbreviation	\\left(\\begin{matrix}${0}\\\\${1}\\end{matrix}\\right)	\N
\.
...
SELECT pg_catalog.setval('proof_id_seq', 2, true);
...
SELECT pg_catalog.setval('rule_condition_id_seq', 1, true);
...
SELECT pg_catalog.setval('rule_id_seq', 12, true);
...
7	\N	49	set	0	f	f	\N	\N	\N	\N
8	7	54	substitute_rule	0	f	f	\N	8	\N	\N
9	8	58	substitute_free	2	f	f	\N	\N	11	\N
10	9	59	substitute_rule	1	f	f	\N	10	\N	\N
11	10	53	substitute_rule	0	f	f	\N	9	\N	\N
\.
...
SELECT pg_catalog.setval('step_id_seq', 11, true);
...
8	49	54	{801499286,4,23,2,14,910648714,3,18,507440212,4,4,2,6,198119638,3,9,358130610,3,10}	{316248928,4,2,2,38,37616246,4,4,2,14,500847396,4,23,2,6,910648714,3,18,198119638,3,9,358130610,3,10,795112762,4,4,2,14,198119638,3,9,501190388,4,23,2,6,910648714,3,18,358130610,3,10}
9	55	1	{670663792,4,2,2,6,1,1,0,198119638,3,9}	{198119638,3,9}
10	56	23	{99079404,4,4,2,6,1,1,0,198119638,3,9}	{1,1,0}
11	50	23	{500847396,4,23,2,6,910648714,3,18,198119638,3,9}	{1,1,0}
12	35	48	{834342920,4,28,2,22,507440212,4,4,2,6,198119638,3,9,358130610,3,10,792166020,4,4,2,6,198119638,3,9,971369676,3,11}	{976989156,4,4,2,14,198119638,3,9,76271144,4,28,2,6,358130610,3,10,971369676,3,11}
13	49	53	{801499286,4,23,2,14,910648714,3,18,507440212,4,4,2,6,198119638,3,9,358130610,3,10}	{795112762,4,4,2,14,198119638,3,9,501190388,4,23,2,6,910648714,3,18,358130610,3,10}
\.
...
SELECT pg_catalog.setval('substitution_id_seq', 13, true);
