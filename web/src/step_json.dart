...
StepBase loadStorageJson(Map json, EdiTeXInterface interface, QedbApi db,
    Element root, StepBase prev, List<Subs> freeConditions) {
  // Get data object.
  final data = json['data'];

  StepBase step;
  if (data is List) {
    final _step = new StepEditor(interface, db, root, prev, freeConditions);
  ...
  if (json['next'] != null) {
    step.next = loadStorageJson(
        json['next'], interface, db, root, step, freeConditions);
  }
